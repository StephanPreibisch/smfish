 ...
 * (https://raw.githubusercontent.com/NeuralEnsemble/neuroConstruct/master/src/ucl/physiol/neuroconstruct/j3D/ConicalFrustum.java)
 * 
...
public class TruncatedCone extends Primitive
{
    ...
    public TruncatedCone (float startRadius, float endRadius, float height)
    {
        this(startRadius, endRadius, height, GENERATE_NORMALS, DEFAULT_DIVISIONS, null);
    }


    public TruncatedCone (float startRadius, float endRadius, float height, Appearance ap)
    {
        this(startRadius, endRadius, height, GENERATE_NORMALS, DEFAULT_DIVISIONS, ap);
    }

    public TruncatedCone (float startRadius, float endRadius, float height, int primflags, Appearance ap)
    {
    ...
    public TruncatedCone(float startRadius, float endRadius, float height, int primflags,
...
// Set Appearance
    ...
    public Node cloneNode(boolean forceDuplicate) {
    	TruncatedCone c = new TruncatedCone(startRadius, endRadius, height, flags, divisions, getAppearance());
